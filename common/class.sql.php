<?php
	...
	define("EZSQL_DB_USER", $_CONFIG["user"]);			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", $_CONFIG["pass"]);		// <-- mysql db password
	define("EZSQL_DB_NAME", $_CONFIG["db"]);		// <-- mysql db pname
	define("EZSQL_DB_HOST", $_CONFIG["host"]);	// <-- mysql server host
	...
	class db {
		...
		//last insert id variable (for insert query user)
		public $lastId = 0;
		...
		function print_error($str = "")
		{
            ...
            /*
            print "<div>Mysql Error - Ne pare rau dar a survenit o eroare. Am notificat administratorii site-ului. Va rugam reveniti in scurt timp.</div>";
            */
